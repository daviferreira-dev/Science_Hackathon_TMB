...
```bash
git clone https://github.com/<seu-usuario>/hackathon-tmb-fpd.git
cd hackathon-tmb-fpd
```

### 2. Crie o ambiente e instale as dependências
```bash
conda create -n tmb-fpd python=3.11 -y
conda activate tmb-fpd
pip install -r requirements.txt
```

Ou direto via pip, sem conda:
```bash
